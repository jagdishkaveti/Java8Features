package com.demo.java8.defaults;
...
public class DefaultMethodExample2 {
    ...
    static Comparator<Student> gpaComparator = Comparator.comparing(Student::getGpa).reversed();
...
/*        List<Student> studentList = StudentDataBase.getAllStudents();
        ...
        *//*sortByGender();
        ...
        Comparator gradeComparator = Comparator.comparing(Student::getGradeLevel);
        stdList.sort(gradeComparator.thenComparing(gpaComparator));
        stdList.stream().distinct().collect(Collectors.toList()).forEach(student -> System.out.println(student));
